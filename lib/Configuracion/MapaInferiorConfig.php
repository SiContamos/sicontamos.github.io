<?php
/**
 * SiContamos Sitio Web - Mapa Inferior Config
 *
...
class MapaInferiorConfig {
    ...
    public $sitio_titulo = 'Sí Contamos';
    ...
    //~ $a[] = '            <a class="fa fa-twitter-square" href="https://twitter.com/000000" target="_blank"></a>';
    //~ $a[] = '            <a class="fa fa-facebook-square" href="https://facebook.com/000000" target="_blank"></a>';
        $a[] = '            <a class="fa fa-github-square" href="https://github.com/SiContamos/sicontamos.github.io" target="_blank"></a>';
        if ($this->en_raiz) {
